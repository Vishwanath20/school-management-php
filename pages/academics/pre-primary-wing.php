...
<section class="py-5">
    <div class="container">
        ...
        <!-- Heading -->
        <h2 class="text-center mb-5 fw-bold text-dark">Pre-Primary School Wing</h2>
        ...
        <div class="row align-items-center mb-5">
            ...
            <div class="col-md-6">
                ...
                <p class="text-muted mt-3">
                    Our Pre-Primary School Wing focuses on empowering students with strong academic excellence 

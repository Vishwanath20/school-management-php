...
<section class="py-5">
    <div class="container">
        ...
        <!-- Heading -->
        <h2 class="text-center mb-5 fw-bold text-dark">Primary School Wing</h2>
        ...
        <div class="row align-items-center mb-5">
            ...
            <div class="col-md-6">
                ...
                <p class="text-muted mt-3">
                    Our Primary School Wing focuses on empowering students with strong academic excellence 
                ...
                <p class="text-muted mt-3" style="color:#444;">
                    Our system takes into account the individualities of different children to provide adequate feedback on the students' learning without putting undue pressure and the introduction of CCE (Continuous Comprehensive Evaluation) is a further step in this direction.
                </p>
            </div>
        </div>

...
?>
   ...
   <!-- Scripts for animations: jQuery, Easing, Waypoints, WOW -->
...
<body>
  ...
  <li class="nav-item dropdown">
    ...
    <ul class="dropdown-menu" aria-labelledby="admissionDropdown">
        ...
        <li>
            <a class="dropdown-item" href="<?php echo $baseUrl; ?>pages/admission/kids.php">
                Registration – DPS Kids
            </a>
        </li> -->
    ...
    <ul class="dropdown-menu" aria-labelledby="rulesDropdown">
        ...
        <li><a class="dropdown-item" href="<?php echo $baseUrl; ?>pages/rules/feec-strucure.php">Fee Structure</a></li>
    ...
    <script>
      // Initialize WOW to use Animate.css v4 class names (animate__*)
      new WOW({
        boxClass: 'wow', // default
        animateClass: 'animate__animated', // use animate.css v4 class prefix
        offset: 100,
        mobile: false
      }).init();
      jQuery(function($){
        // Example: Waypoints helper — add animated class when element enters view
        ...
        // Smooth anchor scrolling using jQuery Easing

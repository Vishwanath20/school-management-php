                    ...
                    <form id="categoryForm" class="forms-sample">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                             ...
                             <div class="col-md-6">
                                <div class="form-group">
                                    <label for="slug">Slug <small>For seo url. | Note: Slug must be uniq for each category.</small></label>
                                    <input type="text" class="form-control" id="slug" name="slug" 
                                           value="<?php echo $category ? htmlspecialchars($category['slug']) : ''; ?>" 
                                           placeholder="Enter slug like. bca-course-in-location" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
...
$(document).ready(function() {
    $('#categoryForm').on('submit', function(e) {
        ...
        $.ajax({
            url: '../../api/course-category/' + (isEdit ? 'update_category.php' : 'add_category.php'),
            type: 'POST',
            data: formData,
            processData: false,
            contentType: false,
